...
<p align="center">
  <img src="https://github.com/betrybe/sd-035-supermercado-pirilampo/blob/main/assets/images/pirilampo-logo.png" width="40%"/>
</p>

Para realizar o projeto, atente-se a cada passo descrito a seguir, e se tiver **qualquer dúvida**, nos envie no _Slack_ da turma! #vqv 🚀

Aqui, você vai encontrar os detalhe55s de como estruturar o desenvolvimento do seu projeto a partir desse repositório, utilizando uma branch específica e um _Pull Request_ para colocar seus códigos.
...
- Data para entrega final do projeto: `13/07/2023 23:59`.
...
- Use o comando: `git clone git@github.com:tryber/sd-035-supermercado-pirilampo.git`

- Entre na pasta do repositório que você acabou de clonar:
  
  - `cd sd-035-supermercado-pirilampo`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-035-supermercado-pirilampo/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-035-supermercado-pirilampo/pulls) e confira se o seu _Pull Request_ está criado
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH35&template=betrybe/sd-0x-supermercado-pirilampo)
